...
def get_model(regnet_name):
    model = None
    if regnet_name == "RegNet_800MF":
        model = models.regnet_y_800mf(weights=None)
    elif regnet_name == "RegNet_1_6GF":
        model = models.regnet_y_1_6gf(weights=None)
    elif regnet_name == "RegNet_3_2GF":
        model = models.regnet_y_3_2gf(weights=None)
    elif regnet_name == "RegNet_8GF":
...
regnet_names = ["RegNet_800MF", "RegNet_1_6GF", "RegNet_3_2GF", "RegNet_8GF"]
